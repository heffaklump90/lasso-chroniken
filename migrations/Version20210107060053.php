 ...
 */
final class Version20210107060053 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `user` ADD CONSTRAINT FK_8D93D649DD28C16D FOREIGN KEY (user_image_id) REFERENCES image (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
